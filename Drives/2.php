				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/home.php">MET Bhujbal Knowlegde City <i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">MET Institute of Engineering</h6>
					<h4>
						<a href="../Homepage/home.php" style="color: white">Placement Management System</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2022-23 MET BKC  | Developed by
              <a href="http://znumerique.azurewebsites.net" target="_parent">SSPD Technologies</a>
				</div>
